...
public interface TicketRepository extends JpaRepository<Ticket,Integer> {
    ...
    @Query("select  t from AclObjectIdentity aoi" +
            ...
            " inner join Ticket t on t.workSpaces.id = aoi.objectIdIdentity" +
            ...
            " and cls.classField = 'md.akdev_service_management.sm.models.Ticket'" )
